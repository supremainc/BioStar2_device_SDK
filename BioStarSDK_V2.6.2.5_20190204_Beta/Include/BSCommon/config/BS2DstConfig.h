...
typedef struct {
	BS2WeekTime startTime;	// When the clock time hits this value, the clock should be put forward as much as the offset.
	BS2WeekTime endTime;	// When the clock time hits this value, the clock should be put backward as much as the offset.
