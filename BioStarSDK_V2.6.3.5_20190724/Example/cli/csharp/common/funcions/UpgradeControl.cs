    ...
    public class UpgradeControl : FunctionModule
    {
        ...
        public void updateSoundResource(IntPtr sdkContext, UInt32 deviceID, bool isMasterDevice)
        {
            ...
            for (UInt32 idx = 0; idx < resourceElement.numResData; ++idx)
            {
                ...
                Console.WriteLine("  Enter index of the sound resource which you want to set [{0} - {1}][{2} - {3}]", BS2SoundIndexEnum.WELCOME, BS2SoundIndexEnum.AUTH_FAIL, (int)BS2SoundIndexEnum.WELCOME, (int)BS2SoundIndexEnum.AUTH_FAIL);
                Console.Write("  >>>> ");
