...
enum EN_MENU_API
{
	...
	MENU_COMM_GET_DEF_LONGRES_TIMEOUT,
	MENU_COMM_SET_DEF_LONGRES_TIMEOUT,
	...
	MENU_COMM_UPG_FIRMWARE,
	MENU_CONF_GET_FACCONFIG,
	MENU_COMM_RESET_FACTORY,
...
std::vector<MENU_ITEM> menuInfoAPI =
{
	...
	{MENU_COMM_GET_SERVER_SSLPORT,			"Get server port (IPV4 SSL)"},
	{MENU_COMM_SET_SERVER_SSLPORT,			"Set server port (IPV4 SSL)"},

	{MENU_COMM_GET_SERVERPORTV6,			"Get server port (IPV6)"},
	{MENU_COMM_SET_SERVERPORTV6,			"Set server port (IPV6)"},
	{MENU_COMM_GET_SERVERSSLPORTV6,			"Get server port (IPV6 SSL)"},
	{MENU_COMM_SET_SERVERSSLPORTV6,			"Set server port (IPV6 SSL)"},

	{MENU_COMM_GET_ENABLEIPV4,				"Get enable IPV4"},
	{MENU_COMM_SET_ENABLEIPV4,				"Set enable IPV4"},
	{MENU_COMM_GET_ENABLEIPV6,				"Get enable IPV6"},
	{MENU_COMM_SET_ENABLEIPV6,				"Set enable IPV6"},

	{MENU_COMM_IS_CONNECTED,				"Check if connected"},

	{MENU_COMM_IS_AUTO_CONNECT,				"Get auto connection"},
	{MENU_COMM_SET_AUTO_CONNECT,			"Set auto connection"},
	
	{MENU_SEPARATOR,						""},
	{MENU_COMM_GET_DEF_RES_TIMEOUT,			"Get default response timeout"},
	{MENU_COMM_SET_DEF_RES_TIMEOUT,			"Set default response timeout"},
	{MENU_COMM_GET_DEF_LONGRES_TIMEOUT,		"Get default response timeout (Long time)"},
	{MENU_COMM_SET_DEF_LONGRES_TIMEOUT,		"Set default response timeout (Long time)"},

	{MENU_COMM_GET_SOCKET_RETRY_COUNT,		"Get retry count"},
	{MENU_COMM_SET_SOCKET_RETRY_COUNT,		"Set retry count"},
	{MENU_COMM_GET_SOCKETSSL_RETRY_COUNT,	"Get retry count (SSL)"},
	{MENU_COMM_SET_SOCKETSSL_RETRY_COUNT,	"Set retry count (SSL)"},
	{MENU_COMM_DEL_SSL,						"Disable SSL"},

	{MENU_SEPARATOR,						""},
	{MENU_COMM_UPG_FIRMWARE,				"Upgrade firmware"},
	{MENU_CONF_GET_FACCONFIG,				"Get factory config"},
	{MENU_COMM_RESET_FACTORY,				"Factory reset"},
	
	{MENU_SEPARATOR,						""},
	{MENU_ELOG_GET_EVENTSMALLBLOB,			"Get event log (using BS2EventSmallBlob)"},
	{MENU_ELOG_GET_EVENTSMALLBLOBEX,		"Get event log (using BS2EventSmallBlobEx)"},
	
	{MENU_SEPARATOR,						""},
	{MENU_USER_ENROLL_FACE,					"Enroll user"},
	{MENU_USER_ENROLL_FACEEX,				"Enroll user (CS40)"},
	...
	{MENU_SEPARATOR,						""},
	{MENU_COMM_SET_DEVICE_LICENSE,			"Enable device license"},
	{MENU_COMM_DEL_DEVICE_LICENSE,			"Disable device license"},
	{MENU_COMM_GET_DEVICE_LICENSE,			"Query device license"},
};
...
std::vector<MENU_ITEM> menuInfoUSBAPI =
{
	...
	{MENU_SEPARATOR,						""},
	{MENU_USB_GET_USR_DBINFO_FROMDIR,		"Get user database information"},
	{MENU_USB_GET_USR_LIST_FROMDIR,			"Get user list"},
	{MENU_USB_GET_USR_INFO_FROMDIR,			"Get user infos"},
	{MENU_USB_GET_USR_DATA_FROMDIR,			"Get user datas"},
	{MENU_USB_GET_USR_INFOEX_FROMDIR,		"Get user infosEx"},
	{MENU_USB_GET_USR_DATAEX_FROMDIR,		"Get user datasEx"},
	{MENU_USB_GET_USRSMALL_INFO_FROMDIR,	"Get user small infos"},
	{MENU_USB_GET_USRSMALL_DATA_FROMDIR,	"Get user small datas"},
	{MENU_USB_GET_USRSMALL_INFOEX_FROMDIR,	"Get user small infosEx"},
	{MENU_USB_GET_USRSMALL_DATAEX_FROMDIR,	"Get user small datasEx"},
	{MENU_USB_GET_USRFACEEX_INFO_FROMDIR,	"Get user faceEx infos"},
	{MENU_USB_GET_USRFACEEX_DATA_FROMDIR,	"Get user faceEx datas"},
	
	{MENU_SEPARATOR,						""},
	{MENU_USB_GET_FILTEREDLOG_FROMDIR,		"Get filtered log"},
	{MENU_USB_GET_LOG_FROMDIR,				"Get log"},
	{MENU_USB_GET_LOG_BLOB_FROMDIR,			"Get log blob"},
	{MENU_USB_GET_LOG_SMALLBLOB_FROMDIR,	"Get log small blob",},
	{MENU_USB_GET_LOG_SMALLBLOBEX_FROMDIR,	"Get log small blobEx",},
};
