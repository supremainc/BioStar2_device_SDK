...
// Deprecated V2.9.4
#define CARD_OPERATION_MASK_LF_EM 						(DEPRECATED_ENUM)CARD_OPERATION_MASK_LF_EM
#define CARD_OPERATION_MASK_LF_PROX 					(DEPRECATED_ENUM)CARD_OPERATION_MASK_LF_PROX
#define CARD_OPERATION_MASK_HF_CSN_MIFARE 				(DEPRECATED_ENUM)CARD_OPERATION_MASK_HF_CSN_MIFARE
#define CARD_OPERATION_MASK_HF_CSN_ICLASS 				(DEPRECATED_ENUM)CARD_OPERATION_MASK_HF_CSN_ICLASS
#define CARD_OPERATION_MASK_HF_SMART_MIFARE 			(DEPRECATED_ENUM)CARD_OPERATION_MASK_HF_SMART_MIFARE
#define CARD_OPERATION_MASK_HF_SMART_MIFARE_DESFIRE 	(DEPRECATED_ENUM)CARD_OPERATION_MASK_HF_SMART_MIFARE_DESFIRE
#define CARD_OPERATION_MASK_HF_SMART_ICLASS 			(DEPRECATED_ENUM)CARD_OPERATION_MASK_HF_SMART_ICLASS
#define CARD_OPERATION_MASK_HF_SMART_ICLASS_SEOS 		(DEPRECATED_ENUM)CARD_OPERATION_MASK_HF_SMART_ICLASS_SEOS
#define CARD_OPERATION_MASK_MOBILE_NFC 					(DEPRECATED_ENUM)CARD_OPERATION_MASK_MOBILE_NFC
#define CARD_OPERATION_MASK_MOBILE_BLE 					(DEPRECATED_ENUM)CARD_OPERATION_MASK_MOBILE_BLE
#define CARD_OPERATION_MASK_HF_CSN_OTHERS 				(DEPRECATED_ENUM)CARD_OPERATION_MASK_HF_CSN_OTHERS
