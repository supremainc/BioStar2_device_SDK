...
enum {
	...
	RTSP_RESOLUTION_TYPE_2 			= 1, //BS3, W3: 720x480
	RTSP_RESOLUTION_TYPE_3 			= 2, //F2, BS3Max: 360x640
	RTSP_RESOLUTION_DEFAULT 		= RTSP_RESOLUTION_TYPE_1,
	RTSP_RESOLUTION_DEFAULT_BS3 	= RTSP_RESOLUTION_TYPE_2,
	RTSP_RESOLUTION_DEFAULT_W3 		= RTSP_RESOLUTION_TYPE_2,
	RTSP_RESOLUTION_DEFAULT_F2 		= RTSP_RESOLUTION_TYPE_3,
	RTSP_RESOLUTION_DEFAULT_BS3M	= RTSP_RESOLUTION_TYPE_3,
};
